...
export const EditComment = (props) => {
    ...
    const handleCommentEdit = async (postid, commentid) => {
        try {
            const res = await Axios.patch(`https://blogigy-backend-api.onrender.com/api/posts/${postid}/comments/${commentid}`,JSON.stringify({commentBody}), {
                headers: {

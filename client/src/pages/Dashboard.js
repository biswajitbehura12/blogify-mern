...
const Dashboard = () => {
    ...
    useEffect(() => {
        ...
        const fetchedPosts = async () => {
            setIsLoading(true);
            const getDatas = await Axios.get('https://blogigy-backend-api.onrender.com/api/posts', {
                signal: signal
            });
    ...
    const handleDeleteButton = async (postid) => {
        try {
            const res = await Axios.delete(`https://blogigy-backend-api.onrender.com/api/posts/post-details/${postid}`, {
                headers: {
